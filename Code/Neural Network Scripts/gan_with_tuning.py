...
Original file is located at
    https://colab.research.google.com/drive/10MVznyGs3HHW3kCfxVUB9KWBEnkRI8UZ
"""
...
from keras.layers import Input, Conv2D, LeakyReLU, BatchNormalization, UpSampling2D, Activation, Flatten, Dense, MaxPooling2D, Conv2DTranspose, Add, Reshape, Dropout
...
def conv_block(x,layers,dropout_rate=0.2,reg_strength=0.005):
  ...
  skip = Conv2D(layers, (3, 3), padding='same', kernel_regularizer=regularizers.l2(reg_strength))(skip)
...
if  not os.path.exists(save_path):
  os.mkdir(save_path)
save_folder = save_path + 'tuned_gan/'
...
ct_test_1 = Image.open('/content/us_test_1.jpg').convert('L')
...
tf.io.write_file('us_test_1.jpeg', tf.image.encode_jpeg(us_test_1, quality=100, format='grayscale'))
us_test_1 = tf.squeeze(us_test_1)
